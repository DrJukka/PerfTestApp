...
function TestThreeClient(jsonData,name) {
    ...
    this.testConnector = new TestThreeConnector(commandData.rounds,commandData.dataAmount,commandData.conTimeout,commandData.conReTryTimeout,commandData.conReTryCount);
