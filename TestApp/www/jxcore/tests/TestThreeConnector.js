...
function TestThreeConnector(rounds,dataAmount,reTryTimeout,reTryMaxCount,dataTimeOut) {
...
TestThreeConnector.prototype.ReStart = function(peer) {
...
TestThreeConnector.prototype.resetDataTimeout = function(peer) {
    var self = this;
    if (self.dataTimerId != null) {
        clearTimeout(self.dataTimerId);
        self.dataTimerId = null;
...
TestThreeConnector.prototype.getResultArray = function() {
