...
function TestTwoConnector(rounds,reTryTimeout,reTryMaxCount,dataTimeOut) {
...
TestTwoConnector.prototype.ReStart = function(peer) {
...
TestTwoConnector.prototype.resetDataTimeout = function(peer) {
    var self = this;
    if (self.dataTimerId != null) {
        clearTimeout(self.dataTimerId);
        self.dataTimerId = null;
...
TestTwoConnector.prototype.getResultArray = function() {
